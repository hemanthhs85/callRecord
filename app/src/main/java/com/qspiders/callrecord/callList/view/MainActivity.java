 package com.qspiders.callrecord.callList.view;
...
import com.qspiders.callrecord.callList.view.adapter.ViewPagerAdapter;
import com.qspiders.callrecord.callList.view.fragment.DayBeforeYesterdayCallsFragment;
import com.qspiders.callrecord.callList.view.fragment.YesterdayCallsFragment;
import com.qspiders.callrecord.callList.view.fragment.IncomingCallsFragment;
...
import com.qspiders.callrecord.app.MixerPaths;
import com.qspiders.callrecord.app.Recordings;
import com.qspiders.callrecord.app.Storage;
import com.qspiders.callrecord.app.SurveysReader;
import com.qspiders.callrecord.helper.PrefManager;
import com.qspiders.callrecord.services.RecordingService;
import com.qspiders.callrecord.widgets.MixerPathsPreferenceCompat;
...
//            tabLayout.setBackgroundDrawable(ContextCompat.getDrawable(this, R.drawable.round_button) );
//        } else {
//            tabLayout.setBackground(ContextCompat.getDrawable(this, R.drawable.round_button));
//        }
        ...
        //loadFragment(new IncomingCallsFragment());
        TextView userName=findViewById(R.id.user_name);
        userName.setText( "Hello " +      new PrefManager(MainActivity.this).getName());
        ...
        if (shared.getBoolean("warning", true)) {
            ...
            builder.setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    SharedPreferences.Editor edit = shared.edit();https://github.com/sheshadri/query-app.git
...
//        final SharedPreferences checkCallenabled = PreferenceManager.getDefaultSharedPreferences(this);
//        if(!checkCallenabled.getBoolean(CallApplication.PREFERENCE_CALL, true)){
...
//        }
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new IncomingCallsFragment(), "Today");
        adapter.addFragment(new YesterdayCallsFragment(), "Yesterday");
        adapter.addFragment(new DayBeforeYesterdayCallsFragment(), "Day before Yesterday");
